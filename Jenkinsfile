node {
    ...
    def dockerhubaccountid = "meajay348"
   ...
   // def mvnHome = tool 'maven-3.8.6'
    ...
    stage('Clone Repo') { 
     ...
     //git url:'https://github.com/vdharmaraj/PGDO_Proj3.git',branch:'main' //update your forked repo
      git url:'https://github.com/meajay348/PGDO_Proj3.git',branch:'main'    
      // Get the Maven tool.
...
//    }
    ...
    stage('Push Image to Remote Repo'){
	 echo "Docker Image Tag Name ---> ${dockerImageTag}"
	     docker.withRegistry('https://hub.docker.com/repository/docker/meajay348/myrepo', 'meajay348') {
